...
export default function FAQAccordion({
  ...
  subheadline = 'Everything you need to know before your salon visit.',
  items = [],
          ...
          {items.map(function (item, i) {
            ...
            return (
              <div key={i} className="rounded-lg border bg-background">
                <button className="flex w-full items-center justify-between p-5 text-left" onClick={function () { setOpenIndex(isOpen ? null : i); }} aria-expanded={isOpen}>
