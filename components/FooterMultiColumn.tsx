...
export default function FooterMultiColumn({
  brand = 'Lumière Salon',
  description = 'Luxury beauty rituals, precision hair artistry, and premium skincare experiences crafted for modern elegance.',
  columns = [
    { title: 'Salon', links: [{ label: 'Services', href: '#services' }, { label: 'Pricing', href: '#pricing' }] },
    { title: 'Company', links: [{ label: 'Our Team', href: '#team' }, { label: 'Gallery', href: '#gallery' }] },
  ...
  return (
    <footer className="bg-foreground text-background">
      <div className="container mx-auto max-w-7xl px-4 py-12 md:py-16">
        ...
        <p className="text-center text-sm text-background/50">{copyright || '\u00a9 ' + new Date().getFullYear() + ' ' + brand + '. All rights reserved.'}</p>
      </div>
    </footer>
  );
}
